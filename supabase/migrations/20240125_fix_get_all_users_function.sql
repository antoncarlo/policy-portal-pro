-- Fix function to get all users with their details (correct column name)
...
COMMENT ON FUNCTION get_all_users_with_details() IS 'Returns all users with their role, agent assignment, and practice count (FIXED: uses user_id instead of created_by)';
