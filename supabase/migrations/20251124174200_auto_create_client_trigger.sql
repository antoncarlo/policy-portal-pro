-- Create trigger to automatically create or link client when inserting a practice
-- This ensures every practice is automatically associated with a client in the directory
...
'Automatically creates a new client or links to an existing one when a practice is inserted. Matches by email first, then by phone+name combination.';
